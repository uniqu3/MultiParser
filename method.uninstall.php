...
$sqlarray   = $dict->DropTableSQL(cms_db_prefix() . "module_multiparser_item");

$dict->ExecuteSQLArray($sqlarray);
$db->DropSequence(cms_db_prefix() . "module_multiparser_item_seq");

$templates = $this->ListTemplates();
foreach ($templates as $template) {
    $this->DeleteTemplate($template, "MultiParser");
}
